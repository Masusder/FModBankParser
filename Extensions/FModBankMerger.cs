...
public static class FModBankMerger
{
    ...
    private static void MergeInto(FModReader dest, FModReader src)
    {
        ...
        foreach (var kv in src.PlaylistNodes) dest.PlaylistNodes[kv.Key] = kv.Value;
        ...
        foreach (var kv in src.ScattererInstrumentNodes) dest.ScattererInstrumentNodes[kv.Key] = kv.Value;
